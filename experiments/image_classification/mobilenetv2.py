...
from cv_task.image_classification.cifar.models import mobilenetv2_w2, mobilenetv2_w1
...
if __name__ == '__main__':
    ...
    model_name = 'mobilenetv2_w2'   # mobilenetv2_w2 / mobilenetv2_w1
    method = 'legodnn'
    device = 'cuda'
    ...
    if dataset_name == 'cifar100':
        if model_name == 'mobilenetv2_w1':
            teacher_model = mobilenetv2_w1(num_classes=100).to(device)
        elif model_name == 'mobilenetv2_w2':
            teacher_model = mobilenetv2_w2(num_classes=100).to(device)
        else:
            print('\033[31mWrong Model!!!\033[0m')
    elif dataset_name == 'cifar10':
        if model_name == 'mobilenetv2_w1':
            teacher_model = mobilenetv2_w1(num_classes=10).to(device)
        elif model_name == 'mobilenetv2_w2':
            teacher_model = mobilenetv2_w2(num_classes=10).to(device)
        else:
            print('\033[31mWrong Model!!!\033[0m')
    else:
