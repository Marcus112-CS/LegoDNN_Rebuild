...
from ..utils.dl.common.model import get_model_flops_and_params, get_model_latency, get_model_size  # thop包/
from ..abstract_model_manager import AbstractModelManager


class CommonModelManager(AbstractModelManager):  # 继承了抽象类AbstractModelManager
    def forward_to_gen_mid_data(self, model, batch_data, device):  # 中间数据生成
    ...
    def dummy_forward_to_gen_mid_data(self, model, model_input_size, device):  # 随机中间数据生成（batch_data随机）
