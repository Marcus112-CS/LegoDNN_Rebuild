...
parser.add_argument('--root_path', default='/home/marcus/newspace/LegoDNN_teacher_model', type=str)
parser.add_argument('--dataset_path', default='/home/marcus/newspace/datasets/teacher_model', type=str)
...
data_record.record_opt(args)  # 记录所有训练选项
