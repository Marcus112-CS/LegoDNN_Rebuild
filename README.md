...
1. Create a conda virtual environment and activate it.
	```
	conda create -n legodnn python==3.6.9
...
3.  Install legodnn
	...
	pip3 install -r requirements.txt (without dataclasses , onnxruntime==1.12.0)
    pip install --upgrade setuptools
    pip install -r requirements.txt (rich==12.1.0 12.6.0)
	```
